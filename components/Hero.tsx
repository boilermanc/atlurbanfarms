    ...
    <section className="relative pt-40 pb-20 md:pt-56 md:pb-32 px-4 md:px-12 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 text-center md:text-left">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-xs font-bold tracking-wide uppercase mb-6">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="text-5xl md:text-7xl font-heading font-extrabold text-gray-900 leading-[1.1] mb-8">
            High-Tech Growing for <span className="text-emerald-600">Urban Spaces.</span>
          </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <button 
              onClick={onShopClick}
              className="w-full sm:w-auto px-8 py-4 bg-gray-900 text-white rounded-2xl font-bold hover:bg-emerald-600 hover:scale-105 active:scale-95 transition-all shadow-xl shadow-gray-200 text-center"
            >
              Shop Seedlings
            </button>
            <button 
              onClick={onAboutClick}
              className="w-full sm:w-auto px-8 py-4 bg-white text-gray-900 border-2 border-gray-100 rounded-2xl font-bold hover:border-emerald-600 transition-all flex items-center justify-center gap-2"
            >
              Learn Our Process
