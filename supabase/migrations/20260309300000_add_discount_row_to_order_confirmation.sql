-- Migration: Add discount row to order confirmation email template
-- Date: 2026-03-09
-- Adds {{discount_row}} variable between subtotal and shipping rows
-- so promo code discounts are visible in confirmation emails
