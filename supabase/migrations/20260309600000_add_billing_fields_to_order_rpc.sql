-- Add billing address fields to the create_order_with_inventory_check RPC.
-- These columns already exist on the orders table but were never included
-- in the INSERT, so billing data was silently dropped.
