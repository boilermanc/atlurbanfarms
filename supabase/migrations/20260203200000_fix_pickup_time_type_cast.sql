-- Fix pickup time fields type casting in create_order_with_inventory_check function
-- The pickup_time_start and pickup_time_end columns are TIME type, but were being
-- inserted as TEXT which causes type mismatch errors
