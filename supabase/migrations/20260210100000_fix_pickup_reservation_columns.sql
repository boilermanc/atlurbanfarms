-- Fix: pickup_reservations INSERT in RPC uses wrong column names.
-- "pickup_location_id" should be "location_id" (actual column name).
-- "customer_email" and "customer_phone" don't exist in the table.
-- Also adds schedule_id which was missing.
