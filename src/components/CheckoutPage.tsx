  ...
  const handleSubmit = async (e: React.FormEvent | React.MouseEvent) => {
    ...
    if (stripeEnabled) {
      ...
      const pendingOrderData = {
        ...
        promotion_discount: promoDiscount, // promo-only discount for usage tracking
                  ...
                  <>
                    ...
                    {addressValidated && !fetchingRates && shippingRates.length > 0 && (() => {
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        {/* Multi-box shipping alert */}
                        {packageBreakdown && packageBreakdown.total_packages > 1 && (
                          <div className="mt-4 p-4 bg-amber-50 rounded-xl border border-amber-200">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="text-sm text-amber-800">
                                <p className="font-semibold">Your order requires {packageBreakdown.total_packages} boxes to ship</p>
                                <p className="mt-1 text-amber-700">Orders with more than 24 seedlings are split across multiple boxes to keep your plants safe during transit. The shipping cost above reflects the total for all {packageBreakdown.total_packages} boxes.</p>
                              </div>
                            </div>
                          </div>
                        )}
