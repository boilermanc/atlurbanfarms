...
const BlackoutDateModal: React.FC<BlackoutDateModalProps> = ({
  isOpen,
  onClose,
  onSave,
  initialDate,
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-200">
            <h2 className="text-xl font-semibold text-slate-800">Add Blackout Date</h2>
            <button
              onClick={onClose}
...
export default BlackoutDateModal;
