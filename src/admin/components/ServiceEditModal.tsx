            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-slate-700 border rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                      errors.service_code ? 'border-red-500' : 'border-slate-600'
                    }`}
                    placeholder="e.g., PRIORITY_MAIL"
                  />
                  {errors.service_code && (
                    <p className="mt-1 text-sm text-red-400">{errors.service_code}</p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-slate-700 border rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                    errors.display_name ? 'border-red-500' : 'border-slate-600'
                  }`}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    Min Transit Days <span className="text-red-400">*</span>
                  </label>
                  <input
                    type="number"
                    min="1"
                    ...
                    className={`w-full px-4 py-3 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                      errors.min_transit_days ? 'border-red-500' : 'border-slate-600'
                    }`}
                  />
                  {errors.min_transit_days && (
                    <p className="mt-1 text-sm text-red-400">{errors.min_transit_days}</p>
                  )}
                </div>

                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    Max Transit Days <span className="text-red-400">*</span>
                  </label>
                  <input
                    type="number"
                    min="1"
                    ...
                    className={`w-full px-4 py-3 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                      errors.max_transit_days ? 'border-red-500' : 'border-slate-600'
                    }`}
                  />
                  {errors.max_transit_days && (
                    <p className="mt-1 text-sm text-red-400">{errors.max_transit_days}</p>
                  )}
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-8 pr-4 py-3 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                        errors.base_price ? 'border-red-500' : 'border-slate-600'
                      }`}
                    />
                  </div>
                  {errors.base_price && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full py-3 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed ${
                          formData.markup_type === 'flat' ? 'pl-8 pr-4' :
                          formData.markup_type === 'percentage' ? 'pl-4 pr-8' : 'px-4'
                        } ${errors.markup_value ? 'border-red-500' : 'border-slate-600'}`}
                      />
                    </div>
                    {errors.markup_value && (
                      <p className="mt-1 text-sm text-red-400">{errors.markup_value}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-8 pr-4 py-3 bg-slate-700 border rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                        errors.free_shipping_threshold ? 'border-red-500' : 'border-slate-600'
                      }`}
                  ...
                  {errors.free_shipping_threshold && (
                    <p className="mt-1 text-sm text-red-400">{errors.free_shipping_threshold}</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label htmlFor="is_enabled" className="text-sm font-medium text-slate-300">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-5 h-5 rounded border-slate-600 bg-slate-700 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-800"
                  />
                  <label htmlFor="is_default" className="text-sm font-medium text-slate-300">
                ...
                <div>
                  {service && (
                    <button
                      ...
                      className="px-4 py-2 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
