...
const AdminHeader: React.FC<AdminHeaderProps> = ({ onMenuClick, onLogout }) => {
  return (
    <header className="h-14 bg-white/70 backdrop-blur-sm border-b border-slate-200/60 flex items-center px-6 flex-shrink-0 sticky top-0 z-10 font-admin-body print-hidden">
