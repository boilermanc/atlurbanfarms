...
const DEFAULT_CONTENT: Record<string, PageContent> = {
  home: {
    ...
    mission: {
      mission_heading: 'The ATL Urban Farms Standard',
      mission_description: 'Every seedling is grown in a climate-controlled, pest-free environment. We use proprietary nutrient mapping to ensure your plants are at peak vitality when they ship.',
      mission_button_text: 'Learn More',
      mission_button_link: '/about',
      mission_image: '',
    },
    sproutify: {
      sproutify_enabled: 'disabled',
      sproutify_heading: 'Sproutify Home',
